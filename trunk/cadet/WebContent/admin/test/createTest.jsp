		...
		<div class="row">
			...
			<div class="container-fluid span9">
				...
				<div class="container-fluid span8">
					<form id="frmCreateTest" class="form-horizontal" method="post"
						action="TestManagement">
						<div class="control-group">
							<label class="control-label" for="txtTestName">Test Name
								: </label>
							<div class="controls">
								<input type="text" id="txtTestName" name="txtTestName"
									placeholder="Test Name" required minlength=2 maxlength=30>
							</div>
						</div>
						...
						<div class="control-group">
							<label class="control-label" for="taTestDesc">Description
								: </label>
							<div class="controls">
								<textarea id="taTestDesc" name="taTestDesc"
									class="span4 nic_edit" style="resize: none;" rows="5"
									placeholder="Test Description & Instructions"></textarea>
							</div>
						</div>

				...
				<table>
					<tr class="tr">
						...
						<td><input class="required email" name="Username"
							id="Username" placeholder="User Email ID" type="text" /></td>
						<td><i style="color: red;" id="username_error"></i></td>
					</tr>

					<tr class="tr">
						<td><label class="Fieldnames">Password :</label></td>
						<td><input class="required" minlength='6'
							equalTo="#Password2" name="Password" id="Password"
							placeholder="Password" type="password" /></td>
					</tr>

					<tr class="tr">
						<td><label class="Fieldnames">Confirm Password :</label></td>
						<td><input class="required" minlength='6' equalTo="#Password"
					...
					<tr class="tr">
						...
						<td><input class="required digits" minlength='10'
							placeholder="Contact No." name="Contact" id="Contact" type="text" /></td>
					</tr>

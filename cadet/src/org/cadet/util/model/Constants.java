...
public class Constants {
	...
	/* Shailee Queries */
	public static final String getNotRegisterTestForUserSql = "select distinct a.TestName, a.TestDate, a.TestDuration, " + " a.testid from test a, testcandidatecategory c  where a.StartTime >= Sysdate() " + " and c.CandidateCategoryName = ? and a.TestId = c.TestId and a.TestId not in (select TestId from result where CUsername=?) order by TestDate;";
